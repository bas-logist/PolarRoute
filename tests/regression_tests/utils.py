...
def calculate_vessel_mesh(config: Dict) -> Dict:
    ...
    LOGGER.info(f'Vessel simulated against {cellbox_count} cellboxes in {end - start:.2f} seconds')
...
def _compare_property_arrays(route_a: Dict, route_b: Dict, property_name: str, 
    ...
    np.testing.assert_array_equal(values_a, values_b, 
                                  err_msg=f'Difference in "{property_name}"')

def _compare_optional_property(route_a: Dict, route_b: Dict, property_name: str) -> None:
    """
